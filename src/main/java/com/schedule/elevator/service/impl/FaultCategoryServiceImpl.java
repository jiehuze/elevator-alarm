...
public class FaultCategoryServiceImpl extends ServiceImpl<FaultCategoryMapper, FaultCategory>
    ...
    @Override
    public Map<String, FaultCategory> getFaultCategoryMap() {
        List<FaultCategory> allCategories = this.lambdaQuery().list();
        return allCategories.stream()
                .collect(Collectors.toMap(FaultCategory::getFaultCode, category -> category));
    }
}