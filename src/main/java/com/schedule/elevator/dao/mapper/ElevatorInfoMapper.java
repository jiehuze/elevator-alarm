...
//            "</if>",
    ...
    @Select({
            ...
            "SELECT ",
            "<![CDATA[",
            "  COUNT(brand_counts.brand) AS totalBrands, ",
            "  SUM(CASE WHEN brand_counts.brand_count <= 10 THEN 1 ELSE 0 END) AS smallBrandsCount, ",
            "  SUM(brand_counts.brand_count) AS totalElevatorCount ",
            "]]>",
            "FROM (",
